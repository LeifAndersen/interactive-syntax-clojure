...
return cljs.core.some.call(null,(function (p1__47866_SHARP_){
return ajax.formats.content_type_matches.call(null,content_type,p1__47866_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__47867){
var map__47868 = p__47867;
var map__47868__$1 = cljs.core.__destructure_map.call(null,map__47868);
var request = map__47868__$1;
var response_format = cljs.core.get.call(null,map__47868__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
ajax.formats.accept_header = (function ajax$formats$accept_header(p__47870){
var map__47871 = p__47870;
var map__47871__$1 = cljs.core.__destructure_map.call(null,map__47871);
var request = map__47871__$1;
var response_format = cljs.core.get.call(null,map__47871__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.call(null,(function (p1__47869_SHARP_){
return ajax.formats.get_accept_entries.call(null,request,p1__47869_SHARP_);
}),formats);
});
/**
