...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__47940){
var map__47941 = p__47940;
var map__47941__$1 = cljs.core.__destructure_map.call(null,map__47941);
var handler = cljs.core.get.call(null,map__47941__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.update.call(null,cljs.core.update.call(null,request,new cljs.core.Keyword(null,"method","method",55703592),ajax.simple.normalize_method),new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951),(function (p1__47942_SHARP_){
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__20754__auto__ = p1__47942_SHARP_;
 ...
 */
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__47943){
var map__47944 = p__47943;
var map__47944__$1 = cljs.core.__destructure_map.call(null,map__47944);
var request = map__47944__$1;
var interceptors = cljs.core.get.call(null,map__47944__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__20754__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__20754__auto__)){
return or__20754__auto__;
} else {
