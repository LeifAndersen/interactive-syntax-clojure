...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__27423){
var map__27424 = p__27423;
var map__27424__$1 = cljs.core.__destructure_map.call(null,map__27424);
var on_write = cljs.core.get.call(null,map__27424__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
if(cljs.core.truth_((function (){var or__20754__auto__ = (!((((node === document.activeElement)) && (((reagent.impl.input.has_selection_api_QMARK_.call(null,node.type)) && (((typeof rendered_value === 'string') && (typeof dom_value === 'string'))))))));
...
var _STAR_force_set_dom_value_STAR__orig_val__27425 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__27426 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__27426);

try{return reagent.impl.input.input_component_set_value.call(null,component);
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__27425);
}}));
} else {
...
if(cljs.core.truth_((function (){var and__20748__auto__ = (!((jsprops == null)));
if(and__20748__auto__){
var and__20748__auto____$1 = jsprops.hasOwnProperty("onChange");
...
}):(cljs.core.truth_((function (){var and__20748__auto__ = original_ref_fn;
...
(jsprops.onChange = (function (p1__27427_SHARP_){
return reagent.impl.input.input_handle_change.call(null,this$,on_change,p1__27427_SHARP_);
}));
