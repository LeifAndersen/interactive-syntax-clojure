...
return (function (){var or__20754__auto__ = w.requestAnimationFrame;
if(cljs.core.truth_(or__20754__auto__)){
return or__20754__auto__;
} else {
var or__20754__auto____$1 = w.webkitRequestAnimationFrame;
if(cljs.core.truth_(or__20754__auto____$1)){
return or__20754__auto____$1;
} else {
var or__20754__auto____$2 = w.mozRequestAnimationFrame;
if(cljs.core.truth_(or__20754__auto____$2)){
return or__20754__auto____$2;
} else {
var or__20754__auto____$3 = w.msRequestAnimationFrame;
...
var n__21841__auto__ = fs.length;
var i = (0);
while(true){
if((i < n__21841__auto__)){
(fs[i]).call(null);
...
(reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__21431__auto__,writer__21432__auto__,opt__21433__auto__){
return cljs.core._write.call(null,writer__21432__auto__,"reagent.impl.batching/RenderQueue");
}));
