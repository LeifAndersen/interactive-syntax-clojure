...
(reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__21431__auto__,writer__21432__auto__,opt__21433__auto__){
return cljs.core._write.call(null,writer__21432__auto__,"reagent.impl.template/NativeWrapper");
}));
...
var G__27432 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__27432,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__27433__delegate = function (args){
...
while (G__27434__i < G__27434__a.length) {G__27434__a[G__27434__i] = arguments[G__27434__i + 0]; ++G__27434__i;}
  args = new cljs.core.IndexedSeq(G__27434__a,0,null);
} 
return G__27433__delegate.call(this,args);};
G__27433.cljs$lang$maxFixedArity = 0;
G__27433.cljs$lang$applyTo = (function (arglist__27435){
var args = cljs.core.seq(arglist__27435);
return G__27433__delegate(args);
});
...
var G__27436 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__27436,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__27438__i < G__27438__a.length) {G__27438__a[G__27438__i] = arguments[G__27438__i + 0]; ++G__27438__i;}
  args = new cljs.core.IndexedSeq(G__27438__a,0,null);
} 
...
var G__27440 = props;
var G__27440__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__27440,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__27440);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__27440__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__20754__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__27441 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__27441,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__27441;
}
})(),id_class);
...
var G__27442 = (cljs.core.count.call(null,argv) - first_child);
switch (G__27442) {
case (0):
...
(reagent.impl.template.HiccupTag.cljs$lang$ctorPrWriter = (function (this__21431__auto__,writer__21432__auto__,opt__21433__auto__){
return cljs.core._write.call(null,writer__21432__auto__,"reagent.impl.template/HiccupTag");
}));
...
var vec__27444 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__27444,(0),null);
var id = cljs.core.nth.call(null,vec__27444,(1),null);
var className = cljs.core.nth.call(null,vec__27444,(2),null);
...
var temp__5724__auto___27447 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5724__auto___27447 == null)){
} else {
var key_27448 = temp__5724__auto___27447;
(jsprops.key = key_27448);
}
...
var temp__5724__auto___27449 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5724__auto___27449 == null)){
} else {
var key_27450 = temp__5724__auto___27449;
(jsprops.key = key_27450);
}
...
var jsprops = (function (){var or__20754__auto__ = reagent.impl.template.convert_prop_value.call(null,((hasprops)?props:null));
if(cljs.core.truth_(or__20754__auto__)){
return or__20754__auto__;
} else {
return ({});
...
var temp__5724__auto___27451 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5724__auto___27451 == null)){
} else {
var key_27452 = temp__5724__auto___27451;
(jsprops.key = key_27452);
}
...
var hasprops = (((props == null)) || (cljs.core.map_QMARK_.call(null,props)));
var jsprops = (function (){var or__20754__auto__ = reagent.impl.template.convert_props.call(null,((hasprops)?props:null),parsed);
if(cljs.core.truth_(or__20754__auto__)){
return or__20754__auto__;
} else {
return ({});
...
var input_class = (function (){var or__20754__auto__ = compiler.reagentInput;
if(cljs.core.truth_(or__20754__auto__)){
return or__20754__auto__;
} else {
...
var temp__5724__auto___27453 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___27453 == null)){
} else {
var key_27454 = temp__5724__auto___27453;
...
var jsprops = (function (){var or__20754__auto__ = props;
if(cljs.core.truth_(or__20754__auto__)){
return or__20754__auto__;
} else {
return ({});
...
var temp__5724__auto___27455 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___27455 == null)){
} else {
var key_27456 = temp__5724__auto___27455;
(jsprops.key = key_27456);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__27457_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__27457_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__27458 = reagent.ratom.check_derefs.call(null,(function (){
...
break;
default:
var G__27463 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__27464 = compiler;
v = G__27463;
compiler = G__27464;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template27468 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template27468 = (function (opts,id,fn_to_element,parse_fn,meta27469){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template27468.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27470,meta27469__$1){
var self__ = this;
var _27470__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template27468(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta27469__$1));
}));

(reagent.impl.template.t_reagent$impl$template27468.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27470){
var self__ = this;
var _27470__$1 = this;
return self__.meta27469;
}));

(reagent.impl.template.t_reagent$impl$template27468.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template27468.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template27468.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template27468.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template27468.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template27468.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta27469","meta27469",324085671,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template27468.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template27468.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template27468");

(reagent.impl.template.t_reagent$impl$template27468.cljs$lang$ctorPrWriter = (function (this__21431__auto__,writer__21432__auto__,opt__21433__auto__){
return cljs.core._write.call(null,writer__21432__auto__,"reagent.impl.template/t_reagent$impl$template27468");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template27468.
 */
reagent.impl.template.__GT_t_reagent$impl$template27468 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template27468(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta27469){
return (new reagent.impl.template.t_reagent$impl$template27468(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta27469));
});

}

return (new reagent.impl.template.t_reagent$impl$template27468(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
