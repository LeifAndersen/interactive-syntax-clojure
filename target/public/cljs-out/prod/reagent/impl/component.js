...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__27388 = c;
var G__27388__$1 = (((G__27388 == null))?null:G__27388.prototype);
if((G__27388__$1 == null)){
return null;
} else {
return G__27388__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__27389 = c;
var G__27389__$1 = (((G__27389 == null))?null:G__27389.prototype);
if((G__27389__$1 == null)){
return null;
} else {
return G__27389__$1.render;
}
})() == null)))));
});
...
var or__20754__auto__ = (function (){var G__27397 = c;
var G__27397__$1 = (((G__27397 == null))?null:G__27397.constructor);
if((G__27397__$1 == null)){
return null;
} else {
return G__27397__$1.displayName;
}
})();
...
var _STAR_current_component_STAR__orig_val__27399 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__27400 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__27400);

try{return reagent.impl.component.wrap_render.call(null,c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__27399);
}});
...
var or__20754__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(cljs.core.truth_(or__20754__auto__)){
return or__20754__auto__;
} else {
var c = this;
...
if((f == null)){
var or__20754__auto____$1 = noargv;
...
var c = this;
var G__27403_27405 = reagent.impl.component.goog$module$goog$object.get.call(null,c,"cljsRatom");
if((G__27403_27405 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__27403_27405);
}
...
if(cljs.core.truth_((function (){var and__20748__auto__ = wrap;
...
var renders_27406 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_27407 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_27406));
...
if((cljs.core.count.call(null,renders_27406) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_27406))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_27407)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_27407)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}


var render_fun = (function (){var or__20754__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__20754__auto__)){
return or__20754__auto__;
} else {
...
var name = (function (){var or__20754__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__20754__auto__)){
return or__20754__auto__;
} else {
var or__20754__auto____$1 = reagent.impl.util.fun_name.call(null,render_fun);
...
var G__27408 = o;
reagent.impl.component.goog$module$goog$object.set.call(null,G__27408,cljs.core.name.call(null,k),v);
...
while (G__27410__i < G__27410__a.length) {G__27410__a[G__27410__i] = arguments[G__27410__i + 0]; ++G__27410__i;}
  args = new cljs.core.IndexedSeq(G__27410__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__27414 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__27415 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__27415);

try{return reagent.impl.component.functional_wrap_render.call(null,compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__27414);
}});
...
var vec__27416 = reagent.impl.component.node$module$react.useState((0));
var _ = cljs.core.nth.call(null,vec__27416,(0),null);
var update_count = cljs.core.nth.call(null,vec__27416,(1),null);
...
var G__27419 = reagent.impl.component.goog$module$goog$object.get.call(null,reagent_state,"cljsRatom");
if((G__27419 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_.call(null,G__27419);
}
});
}),[]);
...
var and__20748__auto__ = reagent.impl.util._STAR_always_update_STAR_ === false;
if(and__20748__auto__){
try{return cljs.core._EQ_.call(null,old_argv,new_argv);
}catch (e27420){var e = e27420;
if(cljs.core.truth_(reagent.debug.has_console)){
(cljs.core.truth_(reagent.debug.tracking)?reagent.debug.track_console:console).warn(["Warning: ","Exception thrown while comparing argv's in shouldComponentUpdate: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(old_argv)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new_argv)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(e)].join(''));
} else {
}
...
var or__20754__auto__ = reagent.impl.component.cached_react_class.call(null,compiler,tag);
if(cljs.core.truth_(or__20754__auto__)){
return or__20754__auto__;
} else {
