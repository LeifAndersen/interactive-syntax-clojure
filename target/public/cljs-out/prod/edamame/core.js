...
return edamame.impl.parser.reader.call(null,x);
});
/**
...
return edamame.impl.parser.source_logging_reader.call(null,x);
});
edamame.core.get_line_number = (function edamame$core$get_line_number(reader){
return edamame.impl.parser.get_line_number.call(null,reader);
});
edamame.core.get_column_number = (function edamame$core$get_column_number(reader){
return edamame.impl.parser.get_column_number.call(null,reader);
});
edamame.core.normalize_opts = (function edamame$core$normalize_opts(opts){
return edamame.impl.parser.normalize_opts.call(null,opts);
});
/**
...
return edamame.core.parse_next.call(null,reader,edamame.impl.parser.normalize_opts.call(null,cljs.core.PersistentArrayMap.EMPTY));
}));

(edamame.core.parse_next.cljs$core$IFn$_invoke$arity$2 = (function (reader,opts){
var v = edamame.impl.parser.parse_next.call(null,opts,reader);
