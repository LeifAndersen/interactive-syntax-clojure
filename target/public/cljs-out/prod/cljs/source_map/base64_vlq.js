...
var digit_41360 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_41361__$1 = (vlq >>> (5));
while(true){
if((vlq_41361__$1 > (0))){
var digit_41362__$1 = (digit_41360 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_41362__$1));

var G__41363 = (vlq_41361__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__41364 = (vlq_41361__$1 >>> (5));
digit_41360 = G__41363;
vlq_41361__$1 = G__41364;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_41360));
}
break;
}
...
var G__41365 = i__$1;
var G__41366 = result__$1;
var G__41367 = shift__$1;
i = G__41365;
result = G__41366;
shift = G__41367;
continue;
